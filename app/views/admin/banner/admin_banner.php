            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <table id="banner-table" class="table table-bordered table-hover">
                        ...
                        <tbody>
                        <?php
                        if (!empty($array_banner)) {
                            foreach ($array_banner as $banner) {
                                ?>
                                <tr>
                                <td>
                                    <?=$banner->text;?>
